...
import com.example.datn.Export.NhanVienCsvExporter;
import com.example.datn.Export.NhanVienExcelExporter;
import com.example.datn.Export.NhanVienPdfExporter;
import com.example.datn.UploadFile.FileUploadUtil;
...
public class NhanVienController {
    ...
    public String listByPage(@PathVariable(name = "pageNum") int pageNum, Model model,
        ...
        Page<NhanVien> page = nhanVienService.listByPage(pageNum, sortField, sortDir, keyword);
        List<NhanVien> listNhanVien = page.getContent();

        long startCount = (pageNum - 1) * NhanVienService.USER_PER_PAGE + 1;
        long endCount = startCount + NhanVienService.USER_PER_PAGE - 1;
    ...
    public String newUser(Model model) {
        ...
        List<ChucVu> listChucVu = nhanVienService.listChucVu();
    ...
    public String saveUser(NhanVien nhanVien, RedirectAttributes redirectAttributes,
        ...
        if (!multipartFile.isEmpty()) {
            ...
            NhanVien saveNhanVien = nhanVienService.save(nhanVien);
            String uploadDir = "user-photos/" + saveNhanVien.getId();
    ...
    public String updateNhanVienEnabledStatus(@PathVariable("id") Integer id,
        ...
        nhanVienService.updateNhanVienEnabledStatus(id, enabled);
