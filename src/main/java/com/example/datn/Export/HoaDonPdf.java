...
public class HoaDonPdf {
    ...
    public void exportToPDF(
        ...
        Paragraph header1 = new Paragraph("THE SUIT HOUSE",new Font(font));
        ...
        if (donHang.getDiaChi() != null){
            ...
            Paragraph paragraph1 = new Paragraph("CỬA HÀNG THE SUIT HOUSE                                      ĐẢM BẢO CHẤT LƯỢNG",
                new Font(font));
        ...
        Paragraph paragraph2 = new Paragraph("        ________                                                         uy tín quý hơn vàng", new Font(font));
        ...
        font.setStyle(Font.NORMAL);
        Paragraph paragraph11 = new Paragraph("THE SUIT HOUSE", new Font(font));
